...
const Deck = observer((props: {
    ...
    console.log('Rendering agents:', agentList.length);
    ...
    if (curZoom > 10) {
        const iconLayer = new IconLayer({
            ...
            data: agentList.map((a) => {
                ...
                // 确保坐标有效
                const lng = a.lng || 116.39;
                const lat = a.lat || 39.90;
        ...
        console.log("Number of agent icons: ", agentList.length);
        ...
        const pointLayer = new ScatterplotLayer({
            ...
            data: agentList.map((a) => {
                ...
                return {
                    ...
                    radius: 15, // 增大点的半径
                    // #1677FF
                    color: [22, 119, 255, 200], // 增加透明度
                }
            }),
            pickable: true,
            radiusScale: 25, // 增大比例
            radiusMinPixels: 3, // 增大最小像素
            radiusMaxPixels: 120, // 增大最大像素
            getPosition: d => d.position,
            getRadius: d => d.radius,
            getFillColor: d => d.color,
            stroked: true, // 添加描边
            getLineColor: [255, 255, 255], // 白色描边
            lineWidthMinPixels: 1,
        });
        console.log("Number of agent points: ", agentList.length);
